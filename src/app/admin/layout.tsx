...
import { initDb, getCurrentSession, logoutAdmin, hasAccessToRoute, UserSession, updateAdminPassword } from "@/utils/db";
...
export default function AdminLayout({
  ...
  if (loading) {
    return (
      <div className="h-screen w-screen flex items-center justify-center bg-slate-50 text-dezprox-primary font-sans relative overflow-hidden">
