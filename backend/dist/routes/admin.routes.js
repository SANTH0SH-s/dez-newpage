...
router.delete("/estimates/:id", estimate_controller_1.EstimateController.deleteEstimate);
router.patch("/estimates/:id/status", estimate_controller_1.EstimateController.updateStatus);
...
router.delete("/enquiries/:id", enquiry_controller_1.EnquiryController.deleteEnquiry);
router.patch("/enquiries/:id/status", enquiry_controller_1.EnquiryController.updateStatus);
